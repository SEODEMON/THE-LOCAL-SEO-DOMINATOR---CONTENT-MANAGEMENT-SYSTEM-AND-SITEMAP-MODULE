<html>
<head>
<title>FOR VERSION 2 GEOSCRIPT THE LOCAL SEO DOMINATOR - CONTENT MANAGEMENT SYSTEM - VERSION 2 SITEMAP MODULE BY JEFF CHILDERS</title>
<meta name="description" content="FOR VERSION 2 GEOSCRIPT THE LOCAL SEO DOMINATOR - CONTENT MANAGEMENT SYSTEM WILL HELP YOU BUILD QUALITY LOCAL LANDING PAGES FOR LOCAL AREAS.VERSION 2 SITEMAP MODULE BY JEFF CHILDERS. ">
...
{
ob_start();
$file_handle = fopen("V2Database.csv", "r")or die("Unable to open file!");
