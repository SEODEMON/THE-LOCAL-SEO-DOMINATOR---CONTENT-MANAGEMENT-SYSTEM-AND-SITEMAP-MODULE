<html>
<head>
<title>VERSION 1 - THE LOCAL SEO DOMINATOR - CONTENT MANAGEMENT SYSTEM - VERSION 1 SITEMAP MODULE BY JEFF CHILDERS</title>
<meta name="description" content="VERSION 1 THE LOCAL SEO DOMINATOR - CONTENT MANAGEMENT SYSTEM WILL HELP YOU BUILD QUALITY LOCAL LANDING PAGES FOR LOCAL AREAS. VERSION 1 SITEMAP MODULE BY JEFF CHILDERS.">
...
<h3>VERSION 1 &nbsp;&nbsp;URLS WILL BE SAVED IN  &nbsp;urllist.txt&nbsp;&nbsp; htaccess File Created!  &nbsp;&nbsp; Now Open sitemap.html &nbsp;&nbsp;Next!</h3>
<?php
...
{
ob_start();
$file_handle = fopen("V1Database.csv", "r")or die("Unable to open file!");
