...
// POSTAL CODES VARABLE-------->>>       [postal_codes]
...
// END POSTAL CODES VARABLE-------->>>       [postal_codes]
...
$template_data = str_replace("[postal_code_css]",'<div id="postal_code" class="postal_code">'. $postalcodes . '</div>',$template_data); 
