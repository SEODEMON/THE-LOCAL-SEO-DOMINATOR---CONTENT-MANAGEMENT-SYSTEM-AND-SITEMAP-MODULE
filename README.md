...
## SPINTAX SUPPORT
### Spin Everything! Text Content, HTML, Images, Videos etc...  This is done with the Spin Tags "<spin>{Cat|Dog|Cow}</spin>"
...
# VERSION 1
### Creates a page for each single zipcode location. Includes a Excel/CSV data file for the United States.

# VERSION 2
### Creates a page for each city and displays all zipcodes in that city.  You will need to create your own Excel/CSV data file for your target location.
